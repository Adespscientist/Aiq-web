...
function Achieve() {
  return (
    <div className="flex flex-col items-center mt-[60px] p-4">
        ...
        <div className="text-[25px] md:text-[38px] text-center w-full md:w-[65%] md:text-left text-[700] my-[20px] md:my-[40px]" style={{color: color.primary}}>Achieve your Goals with our Advanced AI Technologies</div>
